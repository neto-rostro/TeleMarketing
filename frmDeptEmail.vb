...
Public Class frmDeptEmail
    Private Const pxeMasTablex As String = "Department"
    Private Const pxeTableName As String = "Dept_Email"
    ...
    Private Sub txtOther_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        With DataGridView1
            ...
            If Mid(loTxt.Name, 1, 8) = "txtOther" Then
                Select Case loIndex
                    Case 1
                        poDT(lnRow)("sEmailAdd") = txtOther01.Text
                        .Rows(lnRow).Cells(1).Value = poDT(lnRow)("sEmailAdd")
                End Select
            End If
        End With
    End Sub
...
endwithRoll:
    ...
    Private Sub LoadDetail(Optional ByVal showonly As Boolean = False)
        ...
        lsSQL = "SELECT nEntryNox, sEmailAdd FROM " & pxeTableName & _
        ...
        If poDT.Rows.Count = 0 Then
            MsgBox("Department email address not set.", MsgBoxStyle.Information, "Notice")
            Call AddDetail()
        End If
...
loadrecord:
        With DataGridView1
            ...
            For lnCtr = 0 To lnRow - 1
                ...
                .Rows(lnCtr).Cells(1).Value = poDT(lnCtr)("sEmailAdd")
            Next
        ...
        Try
            ...
            If poDTTemp.Rows.Count = 0 Then
                ...
                For lnCtr = 0 To poDT.Rows.Count - 1
                    If poDT(lnCtr)("sEmailAdd") <> "" Then
                        lsSQL = "INSERT INTO " & pxeTableName & _
                                " SET nEntryNox = " & lnCtr + 1 & _
                                    ", sEmailAdd = " & strParm(poDT(lnCtr)("sEmailAdd")) & _
            ...
            Else
                If poDT.Rows.Count > 0 Then
                    ...
                    For lnCtr = 0 To poDT.Rows.Count - 1
                        If poDT(lnCtr)("sEmailAdd") = "" Then GoTo nextrec
                        ...
                        Else
                            lsSQL = "UPDATE " & pxeTableName & _
                                    " SET sEmailAdd = " & strParm(poDT(lnCtr)("sEmailAdd")) & _
                                        ", nEntryNox = " & lnCtr + 1 & _
                                    " WHERE sDeptIDxx = " & strParm(psDeptIDxx) & _
...
nextrec:
    ...
    Private Sub AddDetail()
        ...
        If IFNull(poDT(lnRow)("sEmailAdd")) = "" Then Exit Sub

        poDT.Rows.Add()
endProc:
        lnRow = poDT.Rows.Count - 1
        poDT(lnRow)("nEntryNox") = poDT.Rows.Count
        poDT(lnRow)("sEmailAdd") = ""
        txtOther01.Focus()
    End Sub
