...
Public Class frmBranchMobile
    Private Const pxeMasTablex As String = "Branch"
    Private Const pxeTableName As String = "Branch_Mobile"
...
endwithRoll:
    ...
    Private Sub LoadDetail(Optional ByVal showonly As Boolean = False)
        ...
        lsSQL = "SELECT nEntryNox, sMobileNo FROM " & pxeTableName & _
                        " WHERE sBranchCd = " & strParm(poRow(0)) & _
                        " ORDER BY nEntryNox"
                ...
                If poDT.Rows.Count > 0 Then
                    ...
                    For lnCtr = 0 To poDTTemp.Rows.Count - 1
                        ...
                        If loDR.Length = 0 Then
                            lsSQL = "DELETE FROM " & pxeTableName & _
                                    " WHERE sBranchCd = " & strParm(psBranchCd) & _
...
nextrec:
                ...
                Else
                    lsSQL = "DELETE FROM " & pxeTableName & _
                            " WHERE sBranchCd = " & strParm(psBranchCd)
