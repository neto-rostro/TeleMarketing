...
Public Class frmMCModelFeatures
    Private Const pxeMasTablex As String = "MC_Model"
    Private Const pxeTableName As String = "MC_Model_Features"
    ...
    Private Sub frmMCModelFeaturess_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        If pnLoadx = 1 Then
            pnLoadx = 2
        End If
    End Sub

    Private Sub frmMCModelFeatures_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmMCModelFeatures_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If pnLoadx = 0 Then
