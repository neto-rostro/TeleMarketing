...
Public Class frmOGCallCustInfoReg
    Private WithEvents oTrans As TLMSalesMC
    Private pnLoadx As Integer
    Private pnIndex As Integer
    Private poControl As Control

    Private Sub frmOGCallCustInfoReg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If pnLoadx = 0 Then
            oTrans = New TLMSalesMC(p_oAppDriver, 1230)
            pnLoadx = 1
        End If
        clearFields()
    End Sub
