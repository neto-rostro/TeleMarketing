...
Public Class frmMCModelSpecs
    Private Const pxeMasTablex As String = "MC_Model"
    Private Const pxeTableName As String = "MC_Model_Specs"
    ...
    Private Sub frmMCModelSpecs_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        If pnLoadx = 1 Then
            pnLoadx = 2
        End If
    End Sub

    Private Sub frmMCModelSpecs_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmMCModelSpecs_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If pnLoadx = 0 Then
    ...
    Private Sub InitGrid()
        With DataGridView1
            ...
            .Columns(1).HeaderText = "Specifications"
                    ...
                    If poDT(lnCtr)("sDescript") <> "" Then
                        lsSQL = "INSERT INTO " & pxeTableName & _
                                " SET nEntryNox = " & lnCtr + 1 & _
                                    ", sSpecsIDx = " & strParm(GetNextCode(pxeTableName, "sSpecsIDx", False, p_oAppDriver.Connection, True, p_oAppDriver.BranchCode)) & _
            ...
            Else
                If poDT.Rows.Count > 0 Then
                    ...
                    For lnCtr = 0 To poDTTemp.Rows.Count - 1
                        loDR = poDT.Select("sSpecsIDx = " & strParm(poDTTemp(lnCtr)("sSpecsIDx")))

                        If loDR.Length = 0 Then
                            lsSQL = "DELETE FROM " & pxeTableName & _
                                    " WHERE sModelIDx = " & strParm(psModelIDx) & _
                                        " AND sSpecsIDx = " & strParm(poDTTemp(lnCtr)("sSpecsIDx"))
                    ...
                    For lnCtr = 0 To poDT.Rows.Count - 1
                        ...
                        Else
                            lsSQL = "UPDATE " & pxeTableName & _
                                    " SET sSpecsIDx = " & strParm(GetNextCode(pxeTableName, "sSpecsIDx", False, p_oAppDriver.Connection, True, p_oAppDriver.BranchCode)) & _
                                        ", sDescript = " & strParm(poDT(lnCtr)("sDescript")) & _
                                        ", nEntryNox = " & lnCtr + 1 & _
                                    " WHERE sModelIDx = " & strParm(psModelIDx) & _
