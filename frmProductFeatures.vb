...
Public Class frmProductFeatures
    Private Const pxeTableName As String = "Product_Features"
    ...
    Private Function NewRecord() As Boolean
        ...
        txtField00.Text = GetNextCode(pxeTableName, "sFeatrIDx", False, p_oAppDriver.Connection, True, p_oAppDriver.BranchCode)
            ...
            Select Case p_nEditMode
                Case xeEditMode.MODE_ADDNEW
                    lsSQL = "INSERT INTO " & pxeTableName & _
                                "  SET sFeatrIDx = " & strParm(txtField00.Text) & _
...
endwithRoll:
    ...
    Private Function DeleteRecord() As Boolean
        ...
        lsSQL = "DELETE FROM " & pxeTableName & _
                " WHERE sFeatrIDx = " & strParm(txtField00.Text)
    ...
    Private Function BrowseRecord() As Boolean
        ...
        With p_oAppDriver
            poRow = KwikSearch(p_oAppDriver _
                                            ...
                                            , False _
                                            , lsFilter _
                                            , "sFeatrIDx»sBriefDsc»sDescript" _
                                            , "Feature ID»Brief Desc»Description")
