...
Public Class frmMPModelSpecs
    Private Const pxeMasTablex As String = "CP_Model"
    Private Const pxeTableName As String = "CP_Model_Specs"
    ...
    Private Sub frmMPModelSpecs_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        If pnLoadx = 1 Then
            pnLoadx = 2
        End If
    End Sub

    Private Sub frmMPModelSpecs_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmMPModelSpecs_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If pnLoadx = 0 Then
